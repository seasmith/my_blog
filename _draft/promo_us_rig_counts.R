...
(oc2 <- oc2 %>%
    image_annotate("The Oil Crash As Told By Rig Count",
...
(oc2 <- oc2 %>%
    ...
    image_annotate("Rig Count",
                   location = geometry_point(526, 77),
                   color = clr, font = fnt, size = 14))

(oc2 <- oc2 %>%
    image_annotate("Luke Smith (@lksmth)",
                   location = geometry_point(467, 527),
                   color = "gray70", font = fnt, size = 13) %>%
...
(oc3 <- oc3 %>%
    ...
    image_annotate("Dec 2014",
                   ...
                   color = clr, font = fnt, size = 14) %>%
    image_annotate("Rig Count",
                   location = geometry_point(532, 65),
                   color = clr, font = fnt, size = 14) %>%
    image_annotate("Index",
                   location = geometry_point(532, 80),
                   color = clr, font = fnt, size = 14)
  )
