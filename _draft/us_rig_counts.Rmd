...
## Percent change - Gas
bc_gas_percent_1wk <- bc_base_percent_1wk %+%
  filter(total_comparison, key == "Gas" & Date == max(Date) & percent_1wk != 0)
```
